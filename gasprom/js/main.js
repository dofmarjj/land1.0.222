...
(function () {
  ...
  function modalCalcSum() {
    ...
    arr[3][2] = 28;
    var input =
      $("#modalCalculator .calc-item-inp").val().replace(/\s/g, "") * 1;
    ...
    $("#modalCalculator .day").html(
      $("#modalCalculator .calc-btns a.active").html()
    );
