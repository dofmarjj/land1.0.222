document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".js_reveal__open").forEach((handlerOpen) => {
    handlerOpen.addEventListener("click", ({ target }) => revealOpen(target));
  });
...
function resizeContainer(dataset, initTarget, reveal) {
  ...
  const { paddingLeft, paddingRight } =
    window.getComputedStyle(revealContainer);
