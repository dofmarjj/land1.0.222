...
!(function (t) {
  ...
  function z(t, v, o) {
    var l,
      ...
      U = 1,
      A = 2,
      V = "rtl" === w.dir || 1 === v.ort ? 0 : 100;
    function k(t, e) {
      var r = w.createElement("div");
      return e && ht(r, e), t.appendChild(r), r;
    }
    function D(t, e) {
      var r = k(t, v.cssClasses.origin),
        n = k(r, v.cssClasses.handle);
      return (
        k(n, v.cssClasses.touchArea),
            ...
            return (function (t, e) {
              ...
              if ((t.preventDefault(), p || c)) {
                var h = c ? 0 : 1,
                  ...
                  g = m[h];
                if (null === g) return !1;
                !1 === g && (g = y.getDefaultStep(b[e], c, 10)),
                  (u || l) && (g *= 5),
                  (g = Math.max(g, 1e-7)),
                  (g *= c ? -1 : 1),
                  (s = x[e] + g);
              } else s = d ? v.spectrum.xVal[v.spectrum.xVal.length - 1] : v.spectrum.xVal[0];
              return (
    ...
    function M(t, e) {
      return !!e && k(t, v.cssClasses.connect);
    }
    function r(t, e) {
      return !!v.tooltips[e] && k(t.firstChild, v.cssClasses.tooltip);
    }
    function O() {
    ...
    function j(e, i, o) {
      var s = w.createElement("div"),
        a = [];
      (a[P] = v.cssClasses.valueNormal),
        (a[U] = v.cssClasses.valueLarge),
        (a[A] = v.cssClasses.valueSub);
      var l = [];
      (l[P] = v.cssClasses.markerNormal),
        (l[U] = v.cssClasses.markerLarge),
        (l[A] = v.cssClasses.markerSub);
          ...
          !(function (t, e, r) {
            if ((r = i ? i(e, r) : r) !== N) {
              ...
              (n.className = p(r, v.cssClasses.marker)),
                (n.style[v.style] = t + "%"),
                P < r &&
                  (((n = k(s, !1)).className = p(r, v.cssClasses.value)),
            ...
            if (
              ...
              for (
                ...
                for (
                  ...
                  x[(a = w + i * p).toFixed(5)] = [y.fromStepping(a), 0];
                (l = -1 < v.indexOf(n) ? U : h ? A : P),
                  !e && b && n !== d && (l = 0),
                  (n === d && S) || (x[o.toFixed(5)] = [n, l]),
                  (w = o);
              }
          }),
          x),
    ...
    function J(r, n, i) {
      Object.keys(S).forEach(function (t) {
        ...
        r === e &&
          S[t].forEach(function (t) {
            t.call(a, x.map(v.format.to), n, x.slice(), i || !1, b.slice(), a);
          });
      });
    }
    function K(t, e, r, n, i, o) {
      ...
      return (
        1 < u.length &&
          ...
          (n &&
            0 < e &&
            ((s = y.getAbsoluteDistance(t[e - 1], v.margin, 0)),
            (r = Math.max(r, s))),
          i &&
            e < u.length - 1 &&
            ((s = y.getAbsoluteDistance(t[e + 1], v.margin, 1)),
            (r = Math.min(r, s)))),
        1 < u.length &&
          v.limit &&
          (n &&
            0 < e &&
            ((s = y.getAbsoluteDistance(t[e - 1], v.limit, 0)),
            (r = Math.min(r, s))),
          i &&
            e < u.length - 1 &&
            ((s = y.getAbsoluteDistance(t[e + 1], v.limit, 1)),
            (r = Math.max(r, s)))),
        v.padding &&
          (0 === e &&
            ((s = y.getAbsoluteDistance(0, v.padding[0], 0)),
            (r = Math.max(r, s))),
          e === u.length - 1 &&
            ((s = y.getAbsoluteDistance(100, v.padding[1], 1)),
            (r = Math.min(r, s)))),
    ...
    function rt(t, e, r, n) {
      return (
        !1 !== (e = K(b, t, e, r, n, !1)) &&
        ((function (t, e) {
          (b[t] = e), (x[t] = y.fromStepping(e));
          var r = "translate(" + Q(10 * (tt(e, 0) - V) + "%", "0") + ")";
    ...
    function nt(t) {
      if (s[t]) {
        var e = 0,
          r = 100;
        0 !== t && (e = b[t - 1]), t !== s.length - 1 && (r = b[t]);
        var n = r - e,
          i = "translate(" + Q(tt(e, n) + "%", "0") + ")",
          o = "scale(" + Q(n / 100, "1") + ")";
        s[t].style[v.transformRule] = i + " " + o;
      }
    }
    function it(t, e) {
    ...
    return (
      ...
      (l = k(e, v.cssClasses.base)),
      (function (t, e) {
        var r = k(e, v.cssClasses.connects);
        (u = []), (s = []).push(M(r, t[0]));
